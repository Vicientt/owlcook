...
export function Navigation() {
  ...
  return (
    <nav className="navbar navbar-expand-lg bg-white border-b border-gray-200 sticky top-0 z-50">
      <div className="navbar-collapse max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between w-100">
          ...
          <div className="navbar-nav flex items-center gap-2">
            {navItems.map((item) => {
                  ...
                  <Link to={item.path}>
                    <Button
                      className={`rounded-xl gap-2 ${
                        isActive
                          ? 'bg-gradient-to-r from-[#432C91] to-[#0D9488] hover:from-[#362470] hover:to-[#0F766E] text-white'
                          : 'hover:bg-purple-50'
                      }`}
